...
WebUI.click(findTestObject('Object Repository/OBJ AIRPORT/OBJ_RECORD.F/Page_Frequent Flyer Registration  Royal Orc_0adb01/button_Next'))

WebUI.verifyTextPresent('Please accept all Royal Orchid Plus Terms and Conditions and Privacy Notice before continuing enrolment.', 
    false)

WebUI.click(findTestObject('Object Repository/OBJ AIRPORT/OBJ_RECORD.F/Page_Frequent Flyer Registration  Royal Orc_0adb01/button_OK'))
...
WebUI.click(findTestObject('Object Repository/OBJ AIRPORT/OBJ_RECORD.F/Page_Enrolment  Royal Orchid Plus/button_Next'))

WebUI.verifyElementPresent(findTestObject('Object Repository/OBJ AIRPORT/OBJ_RECORD.F/Page_Enrolment  Royal Orchid Plus/li_This value is required'), 
    0)

WebUI.verifyTextPresent('This value is required.', false)
...
WebUI.click(findTestObject('Object Repository/OBJ AIRPORT/OBJ_RECORD.F/Page_Enrolment  Royal Orchid Plus/a_Next'))
...
WebUI.verifyTextPresent('อีเมลที่ท่านใส่ไม่เหมือนกัน กรุณาลองใหม่อีกครั้ง', false)

WebUI.click(findTestObject('OBJ AIRPORT/REGISTER/Fail-Email'))
...
WebUI.click(findTestObject('Object Repository/OBJ AIRPORT/OBJ_RECORD.F/to_Page4/Page_Enrolment  Royal Orchid Plus/a_Next'))

WebUI.verifyElementText(findTestObject('Object Repository/OBJ AIRPORT/OBJ_RECORD.F/to_Page4/Page_Enrolment  Royal Orchid Plus/li_This value is required'), 
    'This value is required.')

WebUI.verifyTextPresent('This value is required.', false)

WebUI.verifyTextNotPresent('This value is pass.', false)

WebUI.setText(findTestObject('Object Repository/OBJ AIRPORT/OBJ_RECORD.F/Page_Enrolment Royal Orchid Plus2/input_PIN_pin'), 
    'test1234')

WebUI.setText(findTestObject('Object Repository/OBJ AIRPORT/OBJ_RECORD.F/Page_Enrolment Royal Orchid Plus2/input_Confirm PIN_confirm_pin'), 
    'test1')

WebUI.click(findTestObject('Object Repository/OBJ AIRPORT/OBJ_RECORD.F/Page_Enrolment Royal Orchid Plus2/span_Next'))

WebUI.verifyTextPresent('กรุณาใส่ ยืนยันรหัสประจำตัว ให้ตรงกับ รหัสประจำตัว', false)

WebUI.verifyTextNotPresent('ใส่ ยืนยันรหัสประจำตัว ตรงกับ รหัสประจำตัว', false)

WebUI.click(findTestObject('Object Repository/OBJ AIRPORT/OBJ_RECORD.F/Page_Enrolment Royal Orchid Plus2/button_OK'))
